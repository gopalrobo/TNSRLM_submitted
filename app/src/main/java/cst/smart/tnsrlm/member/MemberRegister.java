...
public class MemberRegister extends AppCompatActivity implements Imageutils.ImageAttachmentListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        district.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (districtBlockMap.containsKey(district.getText().toString())) {
                    ArrayAdapter<String> blockadapter = new ArrayAdapter<String>(MemberRegister.this
        ...
        accessLevelAdapter = new ArrayAdapter<String>(MemberRegister.this,
        ...
        commodityAdapter = new ArrayAdapter<String>(MemberRegister.this,
...
//                    }
    ...
    private void locationFetcher(EditText gpsLocal, EditText addressLocal) {
        ...
        gps = new GPSTracker(MemberRegister.this);
        if (gps.canGetLocation()) {
            ...
            try {
                if (addressLocal != null) {
                    ...
                    geocoder = new Geocoder(MemberRegister.this, Locale.getDefault());
