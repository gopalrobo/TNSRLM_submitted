...
public class MainActivityAllSales extends AppCompatActivity {


    private ProgressDialog pDialog;
    private RecyclerView mastersList;
    private MasterAllSalesAdapter mRecyclerAdapterMaster;
    private ArrayList<Sales> itemArrayList = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.salescontent_all_survey);
        ...
        getSupportActionBar().setTitle("Sales Register");
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAllSales.this, SalesRegisterActivity.class);
        ...
        mRecyclerAdapterMaster = new MasterAllSalesAdapter(this, itemArrayList);
                    ...
                    if (!error) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                ...
                                Sales farmer = new Gson().fromJson(dataObject.getString("data"), Sales.class);
                                farmer.setId(dataObject.getString("id"));
                                itemArrayList.add(farmer);

                                tempTotalPurchaseVal = tempTotalPurchaseVal + Float.parseFloat(farmer.totalAmount);
                        ...
                        getSupportActionBar().setSubtitle(String.valueOf(itemArrayList.size()) + " Sales Details");
