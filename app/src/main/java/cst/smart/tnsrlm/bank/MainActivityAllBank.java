...
public class MainActivityAllBank extends AppCompatActivity {



    private ProgressDialog pDialog;
    private RecyclerView mastersList;
    private MasterAllBankAdapter mRecyclerAdapterMaster;
    private ArrayList<BankDetails> itemArrayList = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bankcontent_all_survey);
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAllBank.this, BankDetailsRegister.class);
        ...
        mRecyclerAdapterMaster = new MasterAllBankAdapter(this, itemArrayList);
                    ...
                    if (!error) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                ...
                                BankDetails farmer = new Gson().fromJson(dataObject.getString("data"), BankDetails.class);
                        ...
                        getSupportActionBar().setSubtitle(String.valueOf(itemArrayList.size()) + " Bank Details Details");
