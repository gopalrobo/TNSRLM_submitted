...
public class MainActivityAllFarmer extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAllFarmer.this, FarmerRegister.class);
        ...
        mRecyclerAdapterMaster = new MasterAllFarmerAdapter(this, itemArrayList);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        getSupportActionBar().setSubtitle(String.valueOf(itemArrayList.size()) + " Farmer Details");
