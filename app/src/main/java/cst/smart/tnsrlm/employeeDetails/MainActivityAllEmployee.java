...
import cst.smart.tnsrlm.farmerdetails.Farmer;
import cst.smart.tnsrlm.farmerdetails.FarmerRegister;
import cst.smart.tnsrlm.farmerdetails.MainActivityAllFarmer;


public class MainActivityAllEmployee extends AppCompatActivity {


    private ProgressDialog pDialog;
    private RecyclerView mastersList;
    private MasterAllEmployeeAdapter mRecyclerAdapterMaster;
    private ArrayList<Employee> itemArrayList = new ArrayList<>();


    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.empcontent_all_survey);
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAllEmployee.this, EmployeeRegister.class);
        ...
        mRecyclerAdapterMaster = new MasterAllEmployeeAdapter(this, itemArrayList);
    ...
    private void getAllData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                    ...
                    if (!error) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                ...
                                Employee farmer = new Gson().fromJson(dataObject.getString("data"), Employee.class);
                        ...
                        getSupportActionBar().setSubtitle(String.valueOf(itemArrayList.size()) + " Employee Details");
            ...
            protected Map<String, String> getParams() {
                ...
                localHashMap.put("key", "employeeDetails");
                return localHashMap;
            }
        };
