...
public class MainActivityAllEmployeeFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.empcontent_all_survey, container, false);
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), EmployeeRegister.class);
        ...
        mRecyclerAdapterMaster = new MasterAllEmployeeAdapter(getActivity(), itemArrayList);
