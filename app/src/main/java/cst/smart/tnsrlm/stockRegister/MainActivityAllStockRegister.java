...
public class MainActivityAllStockRegister extends AppCompatActivity {


    private ProgressDialog pDialog;
    private RecyclerView mastersList;
    private MasterAllStockRegisterAdapter mRecyclerAdapterMaster;
    private ArrayList<StockRegister> itemArrayList = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.balancedepositcontent_all_survey);
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAllStockRegister.this, StockRegisterActivity.class);
        ...
        mRecyclerAdapterMaster = new MasterAllStockRegisterAdapter(this, itemArrayList);
    ...
    private void getAllData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                    ...
                    if (!error) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                ...
                                StockRegister farmer = new Gson().fromJson(dataObject.getString("data"), StockRegister.class);
                        ...
                        if (itemArrayList.size() == 0) {
                            Intent intent = new Intent(MainActivityAllStockRegister.this, PurchaseRegistration.class);
                            startActivity(intent);
                        }
                    } else {
                        Intent intent = new Intent(MainActivityAllStockRegister.this, StockRegisterActivity.class);
            ...
            protected Map<String, String> getParams() {
                ...
                localHashMap.put("key", "stockRegister");
                return localHashMap;
            }
        };
    ...
    private void printFunction() {
        ...
        try {
            ...
            AppConfig.addContentStock(document, itemArrayList, MainActivityAllStockRegister.this);
            document.close();
