...
public class MainActivityAllPLF extends AppCompatActivity {


    private ProgressDialog pDialog;
    private RecyclerView mastersList;
    private MasterAllPlfAdapter mRecyclerAdapterMaster;
    private ArrayList<PLF> itemArrayList = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.confcontent_all_survey);

        StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);


        getSupportActionBar().setTitle("Details of PLF");
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAllPLF.this, PLFRegistration.class);
        ...
        mRecyclerAdapterMaster = new MasterAllPlfAdapter(this, itemArrayList);
                    ...
                    if (!error) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                ...
                                PLF farmer = new Gson().fromJson(dataObject.getString("data"), PLF.class);
                        ...
                        getSupportActionBar().setSubtitle(String.valueOf(itemArrayList.size()) + " PLF Details");
