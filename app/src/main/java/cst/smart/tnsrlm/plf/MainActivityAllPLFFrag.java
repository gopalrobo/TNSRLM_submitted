...
public class MainActivityAllPLFFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.confcontent_all_survey, container, false);
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), PLFRegistration.class);
        ...
        mRecyclerAdapterMaster = new MasterAllPlfAdapter(getActivity(), itemArrayList);
